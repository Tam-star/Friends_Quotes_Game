...
const afterAnsweringSentence = document.getElementById(
  "after-answering-sentence"
);
  ...
  return new Promise((resolve, reject) => {
    ...
    fetch(url, options)
      ...
      .catch((err) => {
        ...
        quote.textContent =
          "Une erreur s'est produite. Veuillez nous excuser pour la gêne occasionnée";
      })
      .catch((err) => {
        console.log("Il y a erreur json", err);
        quote.textContent =
          "Une erreur s'est produite. Veuillez nous excuser pour la gêne occasionnée";
      });
  });
...
function endingTest() {
  ...
  if (userScore <= 6) {
    endingSentence.textContent =
      "It looks like you don't really know this great show! Come on, join the fan club and meet those fun New Yorkers!";
  } else if (userScore <= 12) {
    endingSentence.textContent =
      "You might have watched this show a couple of times...but is it enough?";
  } else if (userScore <= 17) {
    endingSentence.textContent =
      "Congratulations! You seem to know pretty well this series! How about another round of the ten seasons ?";
  } else if (userScore == 18) {
    endingSentence.textContent =
      "Congratulations!! You've mastered this test! I know you have watched this show at least a hundred times. Don't worry...me too!";
  }
}
